...
echo "CF-Root 4.4" >> /customkernel/property/customkernel.namedisplay 
echo 83 >> /customkernel/property/customkernel.version.number 
echo 4.4 >> /customkernel/property/customkernel.version.name 
